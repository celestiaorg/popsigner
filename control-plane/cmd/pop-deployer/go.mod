module github.com/Bidon15/popsigner/control-plane/cmd/pop-deployer

go 1.25

require (
	github.com/Bidon15/popsigner/control-plane v0.0.0
...
replace github.com/Bidon15/popsigner/control-plane => ../..
